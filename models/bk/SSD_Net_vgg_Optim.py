...
class BasicConv(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, padding=1, dilation=1, groups=1, relu=True, bn=True, bias=False):
...
def multibox(vgg, extra_layers, cfg, num_classes):
    ...
    # 10*10  256
    loc_layers += [nn.Conv2d(256,cfg[2] * 4, kernel_size=1, padding=0)]
    conf_layers +=[nn.Conv2d(256,cfg[2] * num_classes, kernel_size=1, padding=0)]
...
def build_net(phase, size=300, num_classes=3):

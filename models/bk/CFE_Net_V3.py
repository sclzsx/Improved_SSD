...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, FFB,head, num_classes):
        ...
        self.CFE0 = BasicRFB(256,256,stride=1,scale=1.0)
        self.CFE1 = BasicRFB(256,256,stride=1,scale=1.0)
        self.CFE2 = BasicRFB(256,256,stride=1,scale=1.0)
        self.CFE3 = BasicRFB(256, 256,stride=1,scale=1.0)

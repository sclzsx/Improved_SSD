...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, FFB,head, num_classes):
        ...
        self.CFE0 = CFEModule(512,512)
        self.CFE1 = CFEModule(512,512)
        self.CFE2 = CFEModule(512,512)
        self.CFE3 = CFEModule(512, 512)
...
extras = {
    '320': [256, 'S', 512, 128, 'S', 256, 128, 'S', 256, 128],
...
def PredictionConvolutions(num_classes):
    ...
    for k in range(3):
        loc_layers += [SeperableConv2d(512,6 * 4)]
        conf_layers += [SeperableConv2d(512,6 * num_classes)]
...
def build_net(phase, size=300, num_classes=21):
    ...
    base_ = MobileNetV1()
    extras_ = add_extras(extras[str(size)], 512)
    head_ = PredictionConvolutions(num_classes)
    FFB_ = FFB(512,512,512,512)

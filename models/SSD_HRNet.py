...
def build_head(cfg, num_classes):
    ...
    # 38*38  512
    loc_layers += [nn.Conv2d(32,cfg[0] * 4, kernel_size=1, padding=0)]
    conf_layers +=[nn.Conv2d(32,cfg[0] * num_classes, kernel_size=1, padding=0)]

    # 19*19  512
    loc_layers += [nn.Conv2d(64,cfg[1] * 4, kernel_size=1, padding=0)]
    conf_layers +=[nn.Conv2d(64,cfg[1] * num_classes, kernel_size=1, padding=0)]
...
def build_net(phase, size=320, num_classes=21,neck_type='FPN'):

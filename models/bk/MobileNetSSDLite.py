...
class VGGBase(nn.Module):
    ...
    def load_pretrained_layers(self):
        ...
        # Pretrained VGG base
        pretrained_model = torch.load('weights/mobilenet_sgd_rmsprop_69.526.tar')
...
class SSD300(nn.Module):
    ...
    def forward(self, image):
        ...
        output = (
                ...
                classes_scores.view(classes_scores.size(0), -1, self.n_classes),
            )

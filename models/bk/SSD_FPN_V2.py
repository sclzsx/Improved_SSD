...
base = {
    '320': [64, 'S', 128, 128, 'S', 256, 256, 512, 512, 512, 'S',512,512,512,'S',1024,1024,256,'S',512],
    '512': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'C', 512, 512, 512, 'M',
            512, 512, 512],
}

def TCB():
    cfg = [512, 512, 1024, 512]
...
def PredictionConvolutions(num_classes):
    ...
    for k in n_boxes.keys():
        loc_layers += [nn.Conv2d(256,n_boxes[k] * 4, kernel_size=3, padding=1)]
        conf_layers += [nn.Conv2d(256,n_boxes[k] * num_classes, kernel_size=3, padding=1)]
